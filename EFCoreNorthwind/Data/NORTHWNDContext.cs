...
namespace EFCoreNorthwind.Data
{
    public partial class NORTHWNDContext : DbContext
    {
        ...
        public virtual DbSet<VwNancy> VwNancies { get; set; }
        public virtual DbSet<VwSipUrunlerTarih> VwSipUrunlerTarihs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.;Database=NORTHWND;uid=sa;pwd=1234");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwNancy>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vwNancy");
            ...
            modelBuilder.Entity<VwSipUrunlerTarih>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vwSipUrunlerTarih");
